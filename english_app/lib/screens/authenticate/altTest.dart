...
class MainSigninOrRegister extends StatefulWidget {

  final Function() toggleView;

  const MainSigninOrRegister({required this.toggleView, super.key});

  @override
  State<MainSigninOrRegister> createState() => _MainSigninOrRegister();
}

class _MainSigninOrRegister extends State<MainSigninOrRegister> {
